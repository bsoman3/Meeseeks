...
# 	Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/bsoman3/Meeseeks/master/CarrieSpecials/Carrie-abriged.ps1 -DisableReboots
#
...
choco install -y sysinternals winscp filezilla.commandline windbg procexp processhacker regshot tcpview ida-free ollydbg wireshark hxd explorersuite fakenet ilspy pestudio javadecompiler-gui upx
